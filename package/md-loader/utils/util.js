...
const readComponent = vname => fs.readFileSync(path.resolve(`src/views/md-loader/${blockName}`, `${vname}.vue`), 'utf-8')
const importComponent = vname => `defineAsyncComponent(() => import('@/views/md-loader/${blockName}/${vname}.vue'))`
